...
| `closing-review-loops` | `/closing-review-loops` | Close a review round to zero negotiable rounds — batch findings, fix once, internal self-review clean before re-triggering any external reviewer, push once |
