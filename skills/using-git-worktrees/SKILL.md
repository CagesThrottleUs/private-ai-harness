...
| "Any directory name works" | Explicit instructions beat an existing project-local directory, an existing global legacy path, which beats the `.worktrees/` default. |
